...
class CustomerRequest extends FormRequest
{
    public function rules(): array
    {
        ...
        return [
            ...
            'partner_code' => [
                ...
                Rule::unique('customers', 'partner_code')->ignore($customer?->id)->where('is_deleted', 0),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'partner_code.max' => '相手先コードは20文字以内で入力してください。',
            'partner_code.unique' => 'この相手先コードはすでに使用されています。',
